...
goog.exportSymbol('proto.proto.HeartbeatResponse', null, global);
...
proto.proto.Heartbeat.prototype.clearRequest = function() {
 ...
 * @return {!boolean}
 */
proto.proto.Heartbeat.prototype.hasRequest = function() {
 ...
 * @constructor
 */
proto.proto.HeartbeatResponse = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, null, null);
};
goog.inherits(proto.proto.HeartbeatResponse, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  proto.proto.HeartbeatResponse.displayName = 'proto.proto.HeartbeatResponse';
}
 ...
 * @return {!Object}
 */
proto.proto.HeartbeatResponse.prototype.toObject = function(opt_includeInstance) {
  return proto.proto.HeartbeatResponse.toObject(opt_includeInstance, this);
};
 ...
 *     instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.proto.HeartbeatResponse} msg The msg instance to transform.
 * @return {!Object}
 */
proto.proto.HeartbeatResponse.toObject = function(includeInstance, msg) {
  var f, obj = {
 ...
 * Deserializes binary data (in protobuf wire format).
 * @param {jspb.ByteSource} bytes The bytes to deserialize.
 * @return {!proto.proto.HeartbeatResponse}
 */
proto.proto.HeartbeatResponse.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.proto.HeartbeatResponse;
  return proto.proto.HeartbeatResponse.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.proto.HeartbeatResponse} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.proto.HeartbeatResponse}
 */
proto.proto.HeartbeatResponse.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
...
proto.proto.HeartbeatResponse.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.proto.HeartbeatResponse.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.proto.HeartbeatResponse} message
 * @param {!jspb.BinaryWriter} writer
 */
proto.proto.HeartbeatResponse.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
...
proto.proto.HeartbeatResponse.prototype.clearResponse = function() {
 ...
 * @return {!boolean}
 */
proto.proto.HeartbeatResponse.prototype.hasResponse = function() {
  return jspb.Message.getField(this, 1) != null;
};
